...
1. Select the cube with the LMB. 2. Click on it with the RMB and choose “Copy objects” from the menu.
...
One way to know that you have copied the object is by noticing that you now have two cubes in your outliner: Cube and Cube.001.
...
When you are copying the objects, the number of vertices, tris, and faces increases as it should.
