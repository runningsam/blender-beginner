...
When you confirm it with LMB, you can move it by moving the mouse left, right, up, or down, depending on the position of your loop cut.
...
I will now stop explaining without modeling. There is a lot of stuff that I didn’t show you, but the easiest way to learn is while actually modeling something, so it is time to learn how to model in Blender.