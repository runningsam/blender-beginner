...
1. You can model one thing in Blender in various ways, and most of the time, they

are all correct.

2. There are many shortcuts in Blender. Try to use and learn them from the start
...
3. Now, move the cube with your mouse to the position where you want it to
