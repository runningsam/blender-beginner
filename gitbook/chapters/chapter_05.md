...
Chapter 5 - Transform, annotate, measure, 
and add a cube button 
​
Transform button 
There's only one button left in Object mode that you can use to transform objects. ​
​
Unlike the move, scale, and rotate buttons, which you use to perform only one action at a 
time, the transform button supports any combination of move, rotate, and scale at once. 

![page_37_img_1.png](../images/page_37_img_1.png)

I used this button maybe three times in the beginning while I was still learning Blender, but 
nowadays, I do not use it at all. Still, it is good to know what it is for. 
...
​
​
You can choose between Annotate, Annotate Line, Annotate Polygon, and Annotate Eraser. ​
​
...
This button is easy to understand, so I won’t explain it in more detail. ​
​
You just need to choose what you want to add to the scene (Cube, Cone, Cylinder, UV 
Sphere, or Ico Sphere),  and then draw it into the scene. 