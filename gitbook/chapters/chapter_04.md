...
2. If you want to rotate it along the axes, just press R+ (one of the axes). `R+X` — to rotate it along the X-axis.
...
3. In the end, confirm the rotation with the LMB. How to rotate a cube without using a shortcut (axis rotation)?
...
1. Select the cube with the LMB.
2. If you want to scale it along the axes, just press S+(one of the axes). `S+X` — to scale it along the X-axis.
...
3. In the end, confirm the scale with the LMB. How to scale (resize) a cube without using a shortcut?
