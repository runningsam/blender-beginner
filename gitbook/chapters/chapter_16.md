...
Position the 3D cursor on the plate by clicking “SHIFT+RMB” on the place you want to add 
your next object  
...
So it is time to teach you something called 
SNAP. 
Select the object you want, in this case cylinder, and turn on snap tool by clicking where the 
arrow is pointing, or simply turn it on (and off) by pressing “SHIFT+TAB”. 

![page_144_img_1.png](../images/page_144_img_1.png)

Now move it down along the Z-axis and place the mouse on the face to which you want it to 
snap and confirm it with the LMB. 

![page_144_img_2.png](../images/page_144_img_2.png)

You can snap to the face, vertex, edge, and much more. I will show you more examples of 
snapping in the future, but for now, learn at least face snapping. So be sure that for a 
snap 
target
 is selected the face before you snap. 

![page_145_img_1.png](../images/page_145_img_1.png)

Now you can switch to edit mode with “TAB”. 
Change the view to the top orthographic with 7 on the numpad or click on this blue Z in the 
top right corner. 
...
I just realized that I didn’t teach you about moving the view until now. So let’s correct that 
...
When you are holding the mouse wheel and moving the mouse, you can see all the different 
views. 
...
You can also zoom in/out the view if you click where the arrow is pointing and hold LMB 
while moving the mouse up or down. 

![page_150_img_2.png](../images/page_150_img_2.png)

You can also move the view if you click where the arrow is pointing and hold LMB while 
moving the mouse around. 

![page_150_img_3.png](../images/page_150_img_3.png)

Now we can move on with the cake. 
After you delete all those vertices, move the camera while holding the mouse wheel and 
delete those vertices with “X” as well. 
...
Change the Amount to around 0.021 and the segments to around 3. (You can change those 
as you want. Adjust the numbers as you think they would look best.) 
...
So press it to duplicate selected faces. You want those duplicated faces at the exact same 
position as they were, so just click RMB to return them to the original position. 
...
Select this part of the cake by showing your pointer somewhere on the inside part of the 
cake, and then click “L” for linked. 
...
Scroll the mouse wheel how many loop cuts you want to add. In this case, I added 4 loop 
cuts. 
...
If you want to add material to your objects, click where the arrow is pointing - Material 
properties. 
...
I don’t want to bother you with adding light for now, so just click here and turn off the Scene 
world. 
...
Double-click with the LMB on the object that you want to rename. When letters look like this, 
type your new name. 
...
Try to rename your objects from the start because it will be much easier to work like that, 
...
Switch to object mode. Select the cake. Turn on snap. Make sure that for a 
s
nap target is 
selected the face before you snap. 
...
Click “R” and rotate it as you want. When you decide on your new position for a piece of 
cake, confirm it with the LMB. 

![page_165_img_2.png](../images/page_165_img_2.png)

It is time to learn a new, fun trick. 
If you want to repeat the same action again, you don’t need to duplicate and rotate it again, 
but just click “SHIFT+R” to repeat this step with as many pieces as you want to create. 
