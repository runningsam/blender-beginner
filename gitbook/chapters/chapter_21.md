...
. 
Mapping 
node transforms the input vector by applying translation, rotation, and scale. 
...
The Texture Coordinate
 node retrieves multiple types of texture coordinates. Typically used 
...
Bump. 
Bump 
node generates a perturbed normal from a height texture for bump mapping. 
...
Add Converter -Color Ramp and put it between 
Geometry
 and 
Principled BSDF
. 
...
pseudo-random
 ...
 image textures
. 
 It is most commonly implemented in two, three, or four
 dimensions
, but can be defined for 
...
Change Scale in 
Voronoi texture
 from 65 to something similar to 75. 

![page_236_img_3.png](../images/page_236_img_3.png)

Change strength in 
Bump
 to somewhere around 0.050. 
...
Wave texture 
generates procedural bands or rings with noise. 
...
Change Rotation of Y in 
Mapping
 to 90 degrees so your pages are correctly rotated. 
...
. Ambient occlusion computes how much the hemisphere 
